Public Class DataGridViewTargetsSemanticDiff
    ...
    Public Shadows Event ScoreUpdated()
    ...
    Private colFirstLabel, colSecondLabel As New RichTextColumnLogframe
...
#Region "Cell images"
    ...
    Protected Sub ResetRowImages(ByVal selRow As TargetScalesLikertGridRow)
        selRow.FirstLabelImageDirty = True
        selRow.FirstLabelHeight = 0
        selRow.SecondLabelImageDirty = True
        selRow.SecondLabelHeight = 0
    End Sub
    ...
    Protected Sub ReloadImage_Statement(ByVal selRow As TargetScalesLikertGridRow)
        ...
        With RichTextManager
            ...
            If selRow.FirstLabelImageDirty = True Then
                intColumnWidth = colFirstLabel.Width
            ...
            If selRow.SecondLabelImageDirty = True Then
                intColumnWidth = colSecondLabel.Width

                selRow.SecondLabelImage = .RichTextWithPaddingToBitmap(intColumnWidth, selStatement.SecondLabel, boolSelected)
                selRow.SecondLabelHeight = selRow.SecondLabelImage.Height
            End If
        End With
    End Sub
#End Region
...
#Region "Row heights"
    ...
    Private Function CalculateRowHeight(ByVal RowIndex As Integer) As Integer
        ...
        If selGridRow IsNot Nothing Then
            If selGridRow.FirstLabelHeight > intRowHeight Then intRowHeight = selGridRow.FirstLabelHeight
            If selGridRow.SecondLabelHeight > intRowHeight Then intRowHeight = selGridRow.SecondLabelHeight
        End If
...
#Region "General methods"
    ...
    Protected Sub EditPopulationPercentage(ByVal intColumnIndex As Integer, ByVal intRowIndex As Integer)
    ...
    Private Sub MoveCurrentCell()
        ...
        If intRowIndex = IndexPopulationScore Then
...
#Region "Virtual mode"
    ...
    Protected Overrides Sub OnCellValuePushed(ByVal e As System.Windows.Forms.DataGridViewCellValueEventArgs)
        ...
        If intRowIndex < IndexPopulationTarget Then
            ...
            Select Case strColName
                ...
                Case "SecondLabel"
                    If RowTmp.Statement IsNot Nothing Then
                        UndoRedo.UndoBuffer_Initialise(RowTmp.Statement, "SecondLabel", RowTmp.SecondLabel)

                        RowTmp.SecondLabel = strCellValue
                        RowTmp.SecondLabelImageDirty = True
                ...
                Case Else
                    ...
                    With RowTmp.BooleanValuesMatrixRow
                        ...
                        UndoRedo.BooleanValueChecked(RowTmp.BooleanValuesMatrixRow, intRowIndex, objOldValues, .BooleanValues)
                    End With
            End Select
        End If
    End Sub
    ...
    Protected Overrides Sub OnCancelRowEdit(ByVal e As System.Windows.Forms.QuestionEventArgs)
        ...
        If Me.EditRowFlag = IndexPopulationTarget - 2 AndAlso Me.EditRowFlag = Me.Grid.Count Then
    ...
    Protected Overrides Sub OnNewRowNeeded(ByVal e As System.Windows.Forms.DataGridViewRowEventArgs)
        Me.EditRow = New TargetScalesLikertGridRow()
        Me.EditRowFlag = IndexPopulationTarget - 1
    End Sub
    ...
    Protected Overrides Sub OnRowValidated(ByVal e As System.Windows.Forms.DataGridViewCellEventArgs)
        ...
        If Me.EditRow IsNot Nothing AndAlso (Me.EditRow.OneLabelContainsText And e.RowIndex >= CurrentIndicator.Statements.Count And e.RowIndex < IndexPopulationTarget) Then
...
#Region "Custom painting - general"
    ...
    Private Sub OnCellPainting_NormalCells(ByVal e As System.Windows.Forms.DataGridViewCellPaintingEventArgs)
        ...
        If e.RowIndex >= 0 And e.ColumnIndex >= 0 Then
            ...
            Dim selGridRow As TargetScalesLikertGridRow = Grid(e.RowIndex)
            Dim rImage As Rectangle
            ...
            Select Case strColumnName
                ...
                Case "SecondLabel"
                    ...
                    If selGridRow.SecondLabelImage IsNot Nothing Then
                        rImage = New Rectangle(rCell.X, rCell.Y, selGridRow.SecondLabelImage.Width, selGridRow.SecondLabelImage.Height)
                        CellGraphics.DrawImage(selGridRow.SecondLabelImage, rImage)
                    End If
                    e.Paint(rCell, DataGridViewPaintParts.Border)
    ...
    Public Sub SetSelectionRectangleGridArea()
        ...
        If CurrentCell IsNot Nothing Then
            ...
            If SelectedCells.Count > 1 Then
                ...
                Next
            Else
                If SelectionRectangle.FirstRowIndex >= IndexPopulationTarget Then
                    SelectionRectangle.FirstColumnIndex = 1
                    SelectionRectangle.LastColumnIndex = Me.Columns.Count - 1
                End If
            End If
        End If
    End Sub
