Public Class StructuredComboBoxCell
    ...
    Public Overrides Sub InitializeEditingControl(ByVal rowIndex As Integer, _
        ...
        Dim ctl As StructuredComboBoxEditingControl = CType(DataGridView.EditingControl, StructuredComboBoxEditingControl)
    ...
    Public Overrides ReadOnly Property EditType() As Type
        Get
            ...
            Return GetType(StructuredComboBoxEditingControl)
        End Get
    End Property
    ...
    Public Overrides Function ParseFormattedValue(ByVal formattedValue As Object, ByVal cellStyle As System.Windows.Forms.DataGridViewCellStyle, ByVal formattedValueTypeConverter As System.ComponentModel.TypeConverter, ByVal valueTypeConverter As System.ComponentModel.TypeConverter) As Object
        ...
        If boolFound = False Then
            ...
            Me.Items.Clear()
            Me.Items.AddRange(MeasureUnits.ToArray)
            Dim ctl As StructuredComboBoxEditingControl = CType(DataGridView.EditingControl, StructuredComboBoxEditingControl)
            ctl.Items.Clear()
            ctl.Items.AddRange(MeasureUnits.ToArray)
            With Me.DataGridView
                .SuspendLayout()
                Dim selCol As StructuredComboBoxColumn = CType(.Columns(Me.ColumnIndex), StructuredComboBoxColumn)
                With selCol
                    selCol.Items.Clear()
                    selCol.Items.AddRange(MeasureUnits.ToArray)
                End With
                .ResumeLayout()
            End With
        End If
...
Public Class StructuredComboBoxColumn
    Inherits DataGridViewComboBoxColumn

    Public Sub New()
        'Set the type used in the DataGridView
        MyBase.New()
        Me.CellTemplate = New StructuredComboBoxCell
    End Sub
    ...
    Public Overrides Property CellTemplate() As DataGridViewCell
        ...
        Set(ByVal value As DataGridViewCell)
            ...
            If (value IsNot Nothing) AndAlso _
                Not value.GetType().IsAssignableFrom(GetType(StructuredComboBoxCell)) _
                Then
                Throw New InvalidCastException("Must be a ComboBox cell")
            End If
...
Public Class StructuredComboBoxEditingControl
    Inherits ComboBox
